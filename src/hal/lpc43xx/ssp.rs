...
use hal::lpc43xx::peripheral_clock::{PeripheralClock, SSP0Clock, SSP1Clock};
use hal::lpc43xx::system_clock::system_clock;
...
mod reg {
  ...
  extern {
    #[link_name="lpc43xx_iomem_SSP0"] pub static SSP0: SSP;
    #[link_name="lpc43xx_iomem_SSP1"] pub static SSP1: SSP;
  }
}
