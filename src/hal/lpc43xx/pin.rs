...
impl Pin {
  ...
  fn setup_adc(&self) {
    ...
    let pclk = ::hal::lpc43xx::system_clock::system_clock();
...
mod reg {
  ...
  extern {
    #[link_name="lpc43xx_iomem_PINSEL0"]  pub static PINSEL0:  PINSEL;
    #[link_name="lpc43xx_iomem_PINSEL1"]  pub static PINSEL1:  PINSEL;
    #[link_name="lpc43xx_iomem_PINSEL2"]  pub static PINSEL2:  PINSEL;
    #[link_name="lpc43xx_iomem_PINSEL3"]  pub static PINSEL3:  PINSEL;
    #[link_name="lpc43xx_iomem_PINSEL4"]  pub static PINSEL4:  PINSEL;
    #[link_name="lpc43xx_iomem_PINSEL7"]  pub static PINSEL7:  PINSEL;
    #[link_name="lpc43xx_iomem_PINSEL9"]  pub static PINSEL9:  PINSEL;
    #[link_name="lpc43xx_iomem_PINSEL10"] pub static PINSEL10: PINSEL;
  }

  ioreg_old!(PINMODE: u32, value);
  reg_rw!(PINMODE, u32, value, set_value, value);
  extern {
    #[link_name="lpc43xx_iomem_PINMODE0"] pub static PINMODE0: PINMODE;
    #[link_name="lpc43xx_iomem_PINMODE1"] pub static PINMODE1: PINMODE;
    #[link_name="lpc43xx_iomem_PINMODE2"] pub static PINMODE2: PINMODE;
    #[link_name="lpc43xx_iomem_PINMODE3"] pub static PINMODE3: PINMODE;
    #[link_name="lpc43xx_iomem_PINMODE4"] pub static PINMODE4: PINMODE;
    #[link_name="lpc43xx_iomem_PINMODE7"] pub static PINMODE7: PINMODE;
    #[link_name="lpc43xx_iomem_PINMODE9"] pub static PINMODE9: PINMODE;
  }
  ...
  extern {
    #[link_name="lpc43xx_iomem_GPIO0"] pub static GPIO_0: Gpio;
    #[link_name="lpc43xx_iomem_GPIO1"] pub static GPIO_1: Gpio;
    #[link_name="lpc43xx_iomem_GPIO2"] pub static GPIO_2: Gpio;
    #[link_name="lpc43xx_iomem_GPIO3"] pub static GPIO_3: Gpio;
    #[link_name="lpc43xx_iomem_GPIO4"] pub static GPIO_4: Gpio;
  }
  ...
  extern {
    #[link_name="lpc43xx_iomem_PCONP"]  pub static PCONP:  PCONP;
    #[link_name="lpc43xx_iomem_PCLKSEL0"]  pub static PCLKSEL0: PCLKSEL0;
  }
  ...
  extern {
    #[link_name="lpc43xx_iomem_ADC"]  pub static ADC:  ADC;
  }
}
