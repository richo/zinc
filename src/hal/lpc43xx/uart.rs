...
use hal::lpc43xx::peripheral_clock::PeripheralClock;
use hal::lpc43xx::peripheral_clock::PeripheralClock::UART0Clock;
use hal::lpc43xx::peripheral_clock::PeripheralClock::UART2Clock;
use hal::lpc43xx::peripheral_clock::PeripheralClock::UART3Clock;
...
mod reg {
  ...
  extern {
    #[link_name="lpc43xx_iomem_UART0"] pub static UART0: UART;
    #[link_name="lpc43xx_iomem_UART2"] pub static UART2: UART;
    #[link_name="lpc43xx_iomem_UART3"] pub static UART3: UART;
  }
}
