...
mod reg {
  ...
  extern {
    #[link_name="lpc43xx_iomem_SCS"] pub static SCS: SCS;
    #[link_name="lpc43xx_iomem_FLASHCFG"] pub static FLASHCFG: FLASHCFG;
    #[link_name="lpc43xx_iomem_PLL0CFG"] pub static PLL0CFG: PLL0CFG;
    #[link_name="lpc43xx_iomem_PLL0CON"] pub static PLL0CON: PLL0CON;
    #[link_name="lpc43xx_iomem_CCLKCFG"] pub static CCLKCFG: CCLKCFG;
    #[link_name="lpc43xx_iomem_PLL0FEED"] pub static PLL0FEED: PLL0FEED;
    #[link_name="lpc43xx_iomem_CLKSRCSEL"] pub static CLKSRCSEL: CLKSRCSEL;
    #[link_name="lpc43xx_iomem_PLL0STAT"] pub static PLL0STAT: PLL0STAT;
  }
}
