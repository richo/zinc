...
impl Timer {
  ...
  pub fn new(peripheral: TimerPeripheral, counter: u32, divisor: u8) -> Timer {
    use hal::lpc43xx::peripheral_clock::PeripheralClock as Clock;
...
mod reg {
  ...
  extern {
    #[link_name="lpc43xx_iomem_TIMER0"] pub static TIMER0: TIMER;
    #[link_name="lpc43xx_iomem_TIMER1"] pub static TIMER1: TIMER;
    #[link_name="lpc43xx_iomem_TIMER2"] pub static TIMER2: TIMER;
    #[link_name="lpc43xx_iomem_TIMER3"] pub static TIMER3: TIMER;
  }
}
