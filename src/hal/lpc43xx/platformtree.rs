...
mod test {
  ...
  fn fails_to_parse_garbage_attrs() {
    fails_to_build("lpc43xx@mcu { key = 1; }");
  }

  #[test]
  fn builds_lpc43xx_pt() {
    with_parsed("
      lpc43xx@mcu {
        clock {
      ...
      assert_equal_items(items[1].deref(), "
          ...
          pub unsafe fn platformtree_main() -> () {
            ...
            {
                use zinc::hal::lpc43xx::system_clock;
            ...
            let timer = zinc::hal::lpc43xx::timer::Timer::new(
                zinc::hal::lpc43xx::timer::TimerPeripheral::Timer1, 25u32, 4u8);
            let uart_tx = zinc::hal::lpc43xx::pin::Pin::new(
                zinc::hal::lpc43xx::pin::Port::Port0,
                2u8,
                zinc::hal::lpc43xx::pin::Function::AltFunction1,
                core::option::Option::None);
            let uart_rx = zinc::hal::lpc43xx::pin::Pin::new(
                zinc::hal::lpc43xx::pin::Port::Port0,
                3u8,
                zinc::hal::lpc43xx::pin::Function::AltFunction1,
                core::option::Option::None);
            let uart = zinc::hal::lpc43xx::uart::UART::new(
                zinc::hal::lpc43xx::uart::UARTPeripheral::UART0,
                115200u32,
                8u8,
                zinc::hal::uart::Parity::Disabled,
                1u8);
            let led4 = zinc::hal::lpc43xx::pin::Pin::new(
                zinc::hal::lpc43xx::pin::Port::Port1,
                23u8,
